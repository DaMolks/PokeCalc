...
// import directly from source to avoid workspace resolution during tests
import { ingestSave } from '../../../packages/save-ingest/src';
...
program
  .command('rank')
  .requiredOption('--parents <file>', 'CSV file with parents')
  .requiredOption('--target <file>', 'Target configuration JSON')
...
program
  .command('ingest')
  .requiredOption('--save <file>', 'path to .sav or .pk4 file')
